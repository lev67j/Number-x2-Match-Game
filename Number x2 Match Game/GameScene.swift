...
struct GameConfig {
    ...
    static let backgroundColors: [Int: UIColor] = [
        2: UIColor(red: 1.0, green: 0.2, blue: 0.2, alpha: 1.0),
        4: UIColor(red: 0.2, green: 1.0, blue: 0.2, alpha: 1.0),
        8: UIColor(red: 0.8, green: 0.2, blue: 1.0, alpha: 1.0),
        16: UIColor(red: 1.0, green: 0.6, blue: 0.0, alpha: 1.0),
        32: UIColor(red: 1.0, green: 1.0, blue: 0.2, alpha: 1.0),
        64: UIColor(red: 1.0, green: 0.4, blue: 0.7, alpha: 1.0),
        128: UIColor(red: 0.2, green: 1.0, blue: 0.8, alpha: 1.0)
    ]
...
class GameScene: SKScene {
    ...
    func setupScoreLabels() {
        ...
        scoreLabel.fontSize = GameConfig.scoreFontSize
        scoreLabel.fontColor = .white
        scoreLabel.position = CGPoint(x: size.width / 2, y: topOfGrid + 50 + 40) // 50px отступ + высота шрифта
        ...
        bestScoreLabel.fontSize = GameConfig.bestScoreFontSize
        bestScoreLabel.fontColor = .white
        bestScoreLabel.position = CGPoint(x: size.width / 2, y: topOfGrid + 50) // 50px отступ
    ...
    // Слияние с эффектами и обновлением счета
    ...
    func endGame() {
        ...
        // Задержка перед перезапуском, чтобы игрок увидел сообщение
...
class GameScene: SKScene {
    ...
    func setupScoreLabels() {
        ...
        bestScoreLabel.fontSize = GameConfig.bestScoreFontSize
        bestScoreLabel.fontColor = .white
        bestScoreLabel.position = CGPoint(x: size.width / 2, y: size.height - 100)
        bestScoreLabel.zPosition = 10
        addChild(bestScoreLabel)
    }
